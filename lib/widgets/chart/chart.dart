...
class Chart extends StatelessWidget {
  ...
  List<ExpensesBucket> get buckets {
    return [
      ExpensesBucket.forCategory(expenses, Categorycha.food),
      ExpensesBucket.forCategory(expenses, Categorycha.leisure),
      ExpensesBucket.forCategory(expenses, Categorycha.travel),
      ExpensesBucket.forCategory(expenses, Categorycha.work),
    ];
  }
